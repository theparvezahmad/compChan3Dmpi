...
!=======================================================================
!For best viewing, set Tab Width = 2
!All variables prefixed with tmp are scratch variables.
!-----------------------------------------------------------------------
!												 Input and Output Files
!-----------------------------------------------------------------------
!Input : A initial solution, 		1) 3D.dat
!
!Output: Mutiple files, namely 	1) KE.dat
!																2) massflow.dat
!																3) ubulk.dat
!																4) rhobulk.dat
!																5) tauWall.dat
...
!
!-----------------------------------------------------------------------
!												Description of large Arrays
!-----------------------------------------------------------------------
!1) solV :: 1st Dimension : Physical x coordinate ; extent : 0:nP(1)+1
!						2nd Dimension : Physical y coordinate ; extent : 0:nP(2)+1
!						3nd Dimension : Physical z coordinate ; extent : 0:nP(3)+1
!						4th Dimension : Components of solution vector ; extent : 5
!						5th Dimension : Present and previous solution ; extent : 2

!1) var  :: 1st Dimension : Physical x coordinate ; extent : 0:nP(1)+1
!						2nd Dimension : Physical y coordinate ; extent : 0:nP(2)+1
!						3nd Dimension : Physical z coordinate ; extent : 0:nP(3)+1
!						4th Dimension : Primitive variables, Rho,U,V,W,E,T,P ; extent : 7
