...
do id=0,nproc-1
	write(filename,'(a,i3.3,a)')'3D',id+1,'.dat'
	...
	do k=bb(3,id),ee(3,id)
		...
		read(12,*)
			do i=bb(1,id),ee(1,id)
				read(12,101,iostat=st) x1(i),x2(j),x3(k),var(i,j,k,1),var(i,j,k,2),var(i,j,k,3),var(i,j,k,4)	&
...
!-----------------------------------------------------------------------
!=====================Write combined file===============================
open(unit=12,file='3D.dat')
write(12,103) 'TITLE ="',time,nstep,'"'
write(12,*)'Variables = "x","y","z","u"'
...
do k=1,nZ
	...
	do j=1,nY
		write(12,*)
		do i=1,nX
			write(12,101)x1(i),x2(j),x3(k),var(i,j,k,1),var(i,j,k,2),var(i,j,k,3),var(i,j,k,4)	&
																								 ,var(i,j,k,5),var(i,j,k,6),var(i,j,k,7)
		enddo
	enddo
enddo
